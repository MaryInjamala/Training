...
public class WorkoutController {
	...
	@GetMapping("/id")
	Workout getWorkoutById(@RequestParam int workid) {
		System.out.println(workid);
		return service.getWorkoutById(workid);
	}
	...
	void deleteWorkout(@RequestParam int workId) {
		service.deleteWorkoutById(workId);
	}
